...
// returns all platoon ids in the network
EXTERN libLaneFreePlugin_EXPORT NumericalID* (*get_all_platoon_ids)();
// returns the size of all platoon ids in the network
EXTERN libLaneFreePlugin_EXPORT NumericalID(*get_all_platoon_ids_size)();

// returns all vehicles in a given platoon
EXTERN libLaneFreePlugin_EXPORT NumericalID* (*get_platoon_vehicles_ids)(NumericalID platoon_id);
// returns the size of all vehicles in a given platoon
EXTERN libLaneFreePlugin_EXPORT NumericalID(*get_platoon_vehicles_ids_size)(NumericalID platoon_id);
...
// returns the value that corresponds to the specified type of a single detector, based on the detector's id (NOTE: every time we obtain a measurement from detectors, they are reset)

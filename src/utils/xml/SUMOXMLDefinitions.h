...
enum SumoXMLAttr {
    ...
    SUMO_ATTR_LF_PLATOON_SIZE,
    SUMO_ATTR_LF_PLATOON_TIMESTEP_DISTANCE,
    SUMO_ATTR_LF_LAT_LOW,
    SUMO_ATTR_LF_LAT_HIGH,    
    SUMO_ATTR_LF_DEP_SPEED_LIMIT_DOWNSTREAM,
    SUMO_ATTR_LF_DEPARTSPEED_LIMIT_FRONT_DIST,
    SUMO_ATTR_LF_LEFT_BOUNDARY_LVL_POINTS,
    SUMO_ATTR_LF_LEFT_BOUNDARY_SLOPES,
    SUMO_ATTR_LF_LEFT_BOUNDARY_OFFSETS,
    SUMO_ATTR_LF_LEFT_BOUNDARY_VISUALIZER_COLOR,
    SUMO_ATTR_LF_LEFT_BOUNDARY_VISUALIZER_STEP,
    SUMO_ATTR_LF_LEFT_BOUNDARY_VISUALIZER_LINE_WIDTH,
    SUMO_ATTR_LF_LEFT_BOUNDARY_VISUALIZER_UPDATE_DELAY,
    SUMO_ATTR_LF_INFLUENCED_BY,
    ...
    SUMO_ATTR_LF_RIGHT_BOUNDARY_VISUALIZER_COLOR,
    SUMO_ATTR_LF_RIGHT_BOUNDARY_VISUALIZER_STEP,
    SUMO_ATTR_LF_RIGHT_BOUNDARY_VISUALIZER_LINE_WIDTH,
    // LFPlugin End

...
void simulation_step(){
	...
	// printf("%lld\n",n_myids);
	double speed, speed_y, des_speed, ux, uy, TS = get_time_step_length();
	...
	// char route_id[20]="route0";
	// char type_id[20]="normal_car_35";
	// double x_incr=5, y_incr=3, vx_incr=0;
	// double x_val=x_incr, y_val=y_incr, vx_val=vx_incr;
	// sprintf(veh_name, "%s_%d", type_id,(t+30));
	
	// insert_new_vehicle(veh_name, route_id, type_id, x_val, y_val, vx_val);
